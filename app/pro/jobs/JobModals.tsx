    ...
    >
      ...
      >
        ...
        <div className="px-6 pt-6 pb-4 border-b border-gray-100 flex items-start justify-between gap-4">
          <div>
            <p className="text-xs font-bold tracking-widest uppercase text-sky-500 mb-1">{t('proJobs.quoteModal.kicker')}</p>
        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="q-price" className="text-sm font-bold text-gray-700">
              {t('proJobs.quoteModal.priceLabel')} <span className="text-sky-500">*</span>
            </label>
            <input
              id="q-price"
              type="text"
          ...
          <div className="flex gap-3 pt-1">
            <button
              ...
              className="flex-1 bg-sky-500 hover:bg-sky-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-black rounded-md py-3 text-base transition-colors border-none cursor-pointer"
              style={dg}
            >
      ...
      >
        <div className="p-6">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 border border-gray-200 text-gray-700 hover:bg-gray-50 font-semibold rounded-md py-3 text-sm transition-colors cursor-pointer bg-white"
            >
            ...
            <button
              ...
              disabled={confirming}
              className="flex-1 bg-gray-900 hover:bg-gray-800 disabled:opacity-50 text-white font-black rounded-md py-3 text-sm transition-colors cursor-pointer border-none"
              style={dg}
            >
